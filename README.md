...
| **FXRP3009 on Coston2** | [`0xf073D2f6cf681cc0E3a4d391f661a994Bd32aCFa`](https://coston2-explorer.flare.network/address/0xf073D2f6cf681cc0E3a4d391f661a994Bd32aCFa#code) (source verified, and where the live demo settles) |
...
- **Mainnet is deployed but unexercised.** The contract is source-verified on Flare mainnet against real FXRP, and the EIP-3009 gap it fixes is confirmed there too. But **every settlement in this repo happened on Coston2**, because proving one on mainnet needs real FXRP and FAssets mints in lots of 10 XRP minimum. Deployed is not the same as proven, and the console only ever reports Coston2.
- **Unaudited, and the demo keys are throwaway.** Nothing here should hold value.
